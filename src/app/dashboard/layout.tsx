...
export default function DashboardLayout({
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Sidebar */}
      <div className="w-64 border-r border-border bg-gradient-to-b from-background via-card to-background shadow-2xl relative overflow-hidden">
        ...
        <div className="flex h-full flex-col relative z-10">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-card/20 via-transparent to-muted/30 pointer-events-none" />
          
          {/* Logo/Brand */}
          <div className="relative flex h-14 items-center border-b border-border px-4 bg-gradient-to-r from-card/80 to-muted/40 backdrop-blur-sm">
          ...
          {/* Navigation */}
          <div className="relative flex-1 px-3 py-6 bg-gradient-to-b from-card/40 to-background/60">
            <SidebarNav />
          </div>
          
          {/* User Info */}
          <div className="relative border-t border-border p-4 bg-gradient-to-r from-card/60 to-muted/40 backdrop-blur-sm">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground">Andrew Tallents</p>
      ...
      {/* Main Content */}
      <div className="flex-1 overflow-y-auto bg-gradient-to-br from-background via-card to-background">
        <header className="border-b border-border bg-gradient-to-r from-card/60 to-muted/40 backdrop-blur-sm">
