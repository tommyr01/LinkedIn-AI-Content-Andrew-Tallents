...
export const ConnectionSchema = z.object({
  ...
  fields: z.object({
    ...
    'Last Engagement': z.string().optional(),
...
export const AIPromptSchema = z.object({
  ...
  fields: z.object({
    'Topic': z.string(),
    'Generated Content': z.string(),
    'Voice Score': z.number().optional(),
...
export const formatDateForAirtable = (date: Date): string => {
  return date.toISOString()
}

// Helper to parse Airtable dates
export const parseDateFromAirtable = (dateString: string): Date => {
